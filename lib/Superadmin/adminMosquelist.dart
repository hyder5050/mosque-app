                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      OutlinedButton.icon(
                        ...
                        label: const Text('Pick Location on Map', style: TextStyle(color: Colors.green )),
                        onPressed: () async {
...
class _MapPickerScreenState extends State<MapPickerScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(backgroundColor: Colors.green.shade600,
        title: const Text('Pick Mosque Location')),
      body: GoogleMap(
